...
The \tx{use_dac} accepts a DAC location in the form of a chip, tile and slice
index. The command also accepts several arguments (\tx{src}, \tx{sgn},
\tx{val} and \tx{rng}) which set the \static and \dynamic codes in the block:
\begin{itemize}
